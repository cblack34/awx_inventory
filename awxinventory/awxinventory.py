...
class AwxInventory:
    ...
    def remove_host(self, host_name):
        """
        Remove a vm from the awxinventory.
        Arguments:
    ...
    def add_group(self, name, group_vars=None, hosts=None):
        """
        Add a group to awxinventory, Optionally add group vars, and Optionally add hosts of the group.
        Arguments:
    ...
    def add_group_vars(self, group, group_vars):
        ...
        Arguments:
            :type group: str -- Name of group in awxinventory
    ...
    def add_host_to_group(self, host, group):
        ...
        Arguments:
            ...
            group {str} -- Name of group in awxinventory
        """
        # Make sure host exist
        try:
            self.hosts[host]
